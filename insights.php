                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 wow fadeInUp last-paragraph-no-margin sm-margin-50px-bottom xs-margin-30px-bottom" data-wow-delay="0.2s">
                            <div class="blog-post blog-post-style1 xs-text-center">
                                ...
                                <div class="post-details">
                                    <span class="post-author text-extra-small text-medium-gray  display-block margin-10px-bottom  xs-margin-5px-bottom"><?=$row['date']?> | by <?=$author?></span>
                                    <a href="insight?id=<?=$row['id']?>" class="post-title text-medium text-custom-blue width-90 display-block sm-width-100"><?=$row['heading']?></a>
